...
public class CodeController {
	 ...
	 */
	@GetMapping("/sendcode")
	public ResultVO sendCode(@RequestParam(required = true) String telphone) {
	...
	public ResultVO checkCode(@RequestParam(required = true) String telphone,@RequestParam(required = true) String code) {
